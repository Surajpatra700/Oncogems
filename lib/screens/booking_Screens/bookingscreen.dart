...
class _BookingScreenState extends State<BookingScreen> {
  ...
  String search = "";
  final databaseRef = FirebaseFirestore.instance.collection("Doctor")
      .snapshots();
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                // ]),
                                image: DecorationImage(image: AssetImage("assets/images/doctorpatient.jpg"),
                                        ...
                                        child: ListView.builder(
                                          itemCount: snapshot.data?.docs.length,
                                            itemBuilder: (BuildContext context, int index) {
                                              late String domain =
                                              snapshot.data?.docs[index]['proffession'];
                                                      ...
                                                      child: Card(
                                                        ...
                                                        child: ListTile(
                                                          onTap: () async{
                                                            final Uri url = Uri(
                                                              scheme: "tel",
                                                              path: snapshot.data?.docs[index]['contactnumber'],
                                                            );
                                                            if(await canLaunchUrl(url)){
                                                              await launchUrl(url);
                                                            }else{
                                                              Utils(check: false).toastMessage("Sorry can't launch this url",true);
                                                            }
                                                          },
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: Text(
                                                                          snapshot.data?.docs[index]['contactnumber'],
                                                                        style: TextStyle(
                                                                            color: Colors.black54,
                                                                            fontSize: 15,
                                                        ...
                                                        child: ListTile(
                                                          onTap: () async{
                                                            ...
                                                            if(await canLaunchUrl(url)){
                                                              ...
                                                              Utils(check: false).toastMessage("Sorry can't launch this url",false);
                                                            }
                                                          },
                                                          tileColor: Colors.white,
                                                          leading: Container(
